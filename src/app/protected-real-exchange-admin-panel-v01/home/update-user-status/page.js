                    ...
                    <div className="w-full max-w-5xl mx-auto">
                        ...
                        <div className="flex gap-6 mb-10 justify-center">
                            <button
                                ...
                                className={`px-8 py-4 text-sm md:text-xl font-semibold rounded-xl shadow-md transition-all duration-300 transform hover:-translate-y-1 ${activeTab === "updateStatus"
                            ...
                            <button
                                ...
                                className={`px-8 py-4 text-sm md:text-xl font-semibold rounded-xl shadow-md transition-all duration-300 transform hover:-translate-y-1 ${activeTab === "setDeviceId"
                                    ? "bg-indigo-600 text-white"
                                    : "bg-gray-700 text-gray-200 hover:bg-gray-600"
                                    }`}>
                                Set User Device ID
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <button
                                            ...
                                            disabled={loading}
                                            className={`w-full py-4 rounded-xl text-white text-base font-semibold flex items-center justify-center gap-3 ${loading ? "bg-red-400" : "bg-red-600 hover:bg-red-700"
                                                } transition-all duration-300 transform hover:-translate-y-1 shadow-md`}>
